...
I'm a **Software Engineer** and **Certified Mobile Developer** with expertise in **AI/ML** and full-stack development. Currently working on conversational AI systems at **Yonnov'IA** while pursuing Software Engineering at **INSAT**, Tunisia's premier engineering institution.
...
class Ahmed:
    def __init__(self):
        self.role = "AI Development Intern @ Yonnov'IA"
        self.education = "Software Engineering @ INSAT"
        self.location = "Tunis, Tunisia 🇹🇳"
        
    def interests(self):
        return ["AI/ML", "Mobile Development", "Quality Assurance", "DevOps"]
```

## 🌟 Let's Connect!

I'm passionate about building innovative AI solutions and mobile applications. Always open to discussing new technologies, collaboration opportunities, and interesting projects!

- 💼 Open for **international opportunities**
- 🤝 Available for **technical collaborations**
- 🌍 Interested in **AI/ML projects** and **mobile development**
